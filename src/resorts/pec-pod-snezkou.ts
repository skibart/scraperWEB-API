...
export default async function pecPodSnezkou(): Promise<ReadyObj> {
  try {
    const response = await axios.get('https://www.skiresort.cz/pl/skiarealy/pec-pod-snezkou/pec-lanovky-a-vleky/');
